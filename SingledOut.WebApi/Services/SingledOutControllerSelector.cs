...
namespace SingledOut.WebApi.Services
{
    public class SingledOutControllerSelector: DefaultHttpControllerSelector
    {
        private HttpConfiguration _config;
        public SingledOutControllerSelector(HttpConfiguration config)
            : base(config)
        {
            _config = config;
        }
