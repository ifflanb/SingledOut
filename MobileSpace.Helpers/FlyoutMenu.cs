...
namespace MobileSpace.Helpers
{
	...
	public class FlyOutContainer : FrameLayout
	{
		...
		public FlyOutContainer (Context context, Activity activity) :
		base (context)
		{
			Initialize ();
		}
		...
		public int FlyOutContent { get;	set; }

		public int FlyOutMenu { get; set; }

		View ContentView {
			get {
				return FindViewById (FlyOutContent);
			}
		}

		View MenuView {
			get {
				return FindViewById (FlyOutMenu);
			}
		}
